...
require_line "Experimental Metadata Scope:"
require_line "  policy_id / dedupe_scope / audit event remain experimental metadata only"
require_line "  they are out of v1.0 scope and have no policy enforcement, audit log, or cross-repo dedupe guarantees"
